...
public class MainActivity extends BaseSlidingFragmentActivity implements
	...
	ServiceConnection mServiceConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName name, IBinder service) {
			L.i(MainActivity.class, "Enter onServiceConnected");
			mXxService = ((XXService.XXBinder) service).getService();
			mXxService.registerConnectionStatusCallback(MainActivity.this);
			// 开始连接xmpp服务器
			L.i(MainActivity.class, "onServiceConnected 111");
			if (!mXxService.isAuthenticated()) {
				L.i(MainActivity.class, "onServiceConnected 222");
				...
				L.i(MainActivity.class, "onServiceConnected 333");
			...
			L.i(MainActivity.class, "onServiceConnected 444");
		}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		L.i(MainActivity.class, "Enter onCreate");
		startService(new Intent(MainActivity.this, XXService.class));
		L.i(MainActivity.class, "onCreate  111");
		initSlidingMenu();
		setContentView(R.layout.main_center_layout);
		initViews();
		registerListAdapter();
		L.i(MainActivity.class, "Out onCreate");
	...
	protected void onResume() {
		...
		L.i(MainActivity.class, "onResume bindXMPPService");
		bindXMPPService();
		L.i(MainActivity.class, "bindXMPPService 111");
		getContentResolver().registerContentObserver(
				RosterProvider.CONTENT_URI, true, mRosterObserver);
		L.i(MainActivity.class, "bindXMPPService 222");
		setStatusImage(isConnected());
		mRosterAdapter.requery();
		L.i(MainActivity.class, "bindXMPPService 333");
		XXBroadcastReceiver.mListeners.add(this);
		if (NetUtil.getNetworkState(this) == NetUtil.NETWORN_NONE)
			mNetErrorView.setVisibility(View.VISIBLE);
		else
			mNetErrorView.setVisibility(View.GONE);
		L.i(MainActivity.class, "bindXMPPService 444");
	...
	protected void onPause() {
		super.onPause();
		L.i(MainActivity.class, "onPause");
		getContentResolver().unregisterContentObserver(mRosterObserver);
		L.i(MainActivity.class, "onPause unbindXMPPService");
		unbindXMPPService();
	...
	private void registerListAdapter() {
		L.i(MainActivity.class, "Enter registerListAdapter");
	...
	private void unbindXMPPService() {
		try {
			...
			L.i(MainActivity.class, "[SERVICE] Unbind");
		} catch (IllegalArgumentException e) {
			L.e(MainActivity.class, "Service wasn't bound!");
		}
	}

	private void bindXMPPService() {
		L.i(MainActivity.class, "bindXMPPService, bindService -->");
		boolean bRet = this.getApplicationContext().bindService(new Intent(MainActivity.this, XXService.class),
				mServiceConnection, Context.BIND_AUTO_CREATE
						+ Context.BIND_DEBUG_UNBIND);
		//startService(new Intent(MainActivity.this, XXService.class));
		L.i(MainActivity.class, "bindXMPPService, bindService <--: " + bRet);
	}
	...
	private void startChatActivity(String userJid, String userName) {
		L.i(MainActivity.class, "startChatActivity");
	...
	private void showChildQuickActionBar(View view) {
		L.i(MainActivity.class, "showChildQuickActionBar");
		QuickAction quickAction = new QuickAction(this, QuickAction.HORIZONTAL);
	...
	public void updateRoster() {
		L.i(MainActivity.class, "Enter updateRoster");
		mRosterAdapter.requery();
	}
	...
	private class GetDataTask extends AsyncTask<Void, Void, String[]> {
		...
		protected void onPostExecute(String[] result) {
			...
			L.i(MainActivity.class, "Enter onPostExecute");
