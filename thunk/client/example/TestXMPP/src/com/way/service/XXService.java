...
public class XXService extends BaseService implements EventHandler,
	...
	public IBinder onBind(Intent intent) {
		L.i(XXService.class, "[SERVICE] onBind, " + intent);
		String chatPartner = intent.getDataString();
		L.i(XXService.class, "[SERVICE] onBind 00 : " + chatPartner);
		if ((chatPartner != null)) {
			mIsBoundTo.add(chatPartner);
		}
		L.i(XXService.class, "[SERVICE] onBind 11");
		String action = intent.getAction();
		L.i(XXService.class, "[SERVICE] onBind 22");
	...
	public void onRebind(Intent intent) {
		...
		L.i(XXService.class, "Enter onRebind");
		String chatPartner = intent.getDataString();
		if ((chatPartner != null)) {
			mIsBoundTo.add(chatPartner);
		}
	...
	public boolean onUnbind(Intent intent) {
		L.i(XXService.class, "Enter onUnbind");
		String chatPartner = intent.getDataString();
		if ((chatPartner != null)) {
	...
	public void onCreate() {
		super.onCreate();
		L.i(XXService.class, "Enter onCreate");
		XXBroadcastReceiver.mListeners.add(this);
		L.i(XXService.class, "onCreate 111");
		BaseActivity.mListeners.add(this);
		L.i(XXService.class, "onCreate 222");
		mActivityManager = ((ActivityManager) getSystemService(Context.ACTIVITY_SERVICE));
		L.i(XXService.class, "onCreate 333");
		mPackageName = getPackageName();
		L.i(XXService.class, "onCreate 444");
		mPAlarmIntent = PendingIntent.getBroadcast(this, 0, mAlarmIntent,
				PendingIntent.FLAG_UPDATE_CURRENT);
		registerReceiver(mAlarmReceiver, new IntentFilter(RECONNECT_ALARM));
		L.i(XXService.class, "onCreate 666");
	}

	@Override
	public int onStartCommand(Intent intent, int flags, int startId) {
		L.i(XXService.class, "Enter onStartCommand");
		if (intent != null
	...
	public void Login(final String account, final String password) {
		L.i(XXService.class, "Enter Login");
	...
	public boolean logout() {
		L.i(XXService.class, "Enter logout");
	...
	public void sendMessage(String user, String message) {
		L.i(XXService.class, "sendMessage");
		if (mSmackable != null)
	...
	public boolean isAuthenticated() {
		L.i(XXService.class, "isAuthenticated");
		if (mSmackable != null) {
	...
	public void setStatusFromConfig() {
		L.i(XXService.class, "setStatusFromConfig");
		mSmackable.setStatusFromConfig();
	}

	// 新增联系人
	public void addRosterItem(String user, String alias, String group) {
		L.i(XXService.class, "addRosterItem");
		try {
	...
	public void moveRosterItemToGroup(String user, String group) {
		L.i(XXService.class, "moveRosterItemToGroup");
		try {
	...
	public void renameRosterItem(String user, String newName) {
		L.i(XXService.class, "renameRosterItem");
		try {
	...
	public void renameRosterGroup(String group, String newGroup) {
		L.i(XXService.class, "renameRosterGroup");
	...
	private void postConnectionScuessed() {
		L.i(XXService.class, "postConnectionScuessed");
		mMainHandler.post(new Runnable() {
			public void run() {
				connectionScuessed();
			}
	...
	private void connectionScuessed() {
		L.i(XXService.class, "connectionScuessed");
	...
	public void newMessage(final String from, final String message) {
		L.i(XXService.class, "newMessage");
		mMainHandler.post(new Runnable() {
			public void run() {
	...
	public void rosterChanged() {
		L.i(XXService.class, "rosterChanged");
	...
	public void updateServiceNotification(String message) {
		L.i(XXService.class, "updateServiceNotification");
		if (!PreferenceUtils.getPrefBoolean(this,
	...
	public boolean isAppOnForeground() {
		L.i(XXService.class, "isAppOnForeground");
