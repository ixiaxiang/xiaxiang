package org.xiaxiang.fragment.adapter;
...
//		timeMsg.setText(mListMsgBean.get(position).getMessageTime());
		...
		ImageView sex = (ImageView) v.findViewById(R.id.sex_msg_item);
		sex.setImageResource(mListMsgBean.get(position).getSexDrawableId());
